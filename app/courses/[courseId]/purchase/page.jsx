...
async function getCheckoutData(courseId, userId) {
  ...
  // Check OneId verification status
  ...
  return {
    ...
    verificationDate: verificationData[0]?.oneid_verification_date,
  };
}
...
export default async function PurchasePage({ params }) {
  ...
  // If user is not verified, show verification requirement
  if (!checkoutData.isVerified) {
    return (
  ...
  // User is verified, show purchase form
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 rounded-md border border-green-200 bg-green-50 p-4">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-green-800">Age Verified</h3>
