...
// export const addContent = `INSERT INTO lesson_content (lesson_id, content_type, content) VALUES (?, ?, ?);`;
// export const addContent = `
//         DELETE FROM lesson_content WHERE lesson_id = ? AND content_type = ?;
//         INSERT INTO lesson_content (lesson_id, content_type, content) VALUES (?, ?, ?);`;

export const addContent = `
  INSERT INTO lesson_content (lesson_id, content_type, content) 
  VALUES (?, ?, ?)
